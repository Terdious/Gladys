...
/**
 * @description When a new camera file is detected, upload it to Gladys Plus if needed.
  ...
  try {
    ...
    if (filename === 'index.m3u8') {
      const newFileContentString = fileContent
        .toString()
        .replace(
          `BACKEND_URL_TO_REPLACE/api/v1/service/frigate/camera/streaming/${cameraFolder}/index.m3u8.key`,
