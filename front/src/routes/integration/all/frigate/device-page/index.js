...
export default connect(
  'user,session,httpClient,frigateCameras,frigateStatus,frigateStats,housesWithRooms,getFrigateCamerasStatus,frigateCameraSearch,getFrigateCamerasOrderDir,restartFrigateStatus',
  actions
