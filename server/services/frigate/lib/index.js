...
const { recordMqttMessage } = require('./recordMqttMessage');
const { sendPtzCommand } = require('./sendPtzCommand');
const { sendDlinkPtzCommand } = require('./sendDlinkPtzCommand');
const { setValue } = require('./setValue');
const { configureAdminUser } = require('./configureAdminUser');
const { getImage } = require('./getImage');
const { poll } = require('./poll');
const { updateCameraImage } = require('./updateCameraImage');
const { updateLabelImage } = require('./updateLabelImage');
const { getConfiguration } = require('./getConfiguration');
const { remoteLogin, remoteApiGet } = require('./remoteApi');
const { discoverRemoteCameras } = require('./discoverRemoteCameras');
...
FrigateManager.prototype.recordMqttMessage = recordMqttMessage;
FrigateManager.prototype.sendPtzCommand = sendPtzCommand;
FrigateManager.prototype.sendDlinkPtzCommand = sendDlinkPtzCommand;
FrigateManager.prototype.setValue = setValue;
...
FrigateManager.prototype.updateLabelImage = updateLabelImage;
FrigateManager.prototype.getConfiguration = getConfiguration;
FrigateManager.prototype.remoteLogin = remoteLogin;
FrigateManager.prototype.remoteApiGet = remoteApiGet;
FrigateManager.prototype.discoverRemoteCameras = discoverRemoteCameras;
