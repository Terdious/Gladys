...
export default connect(
  'user,session,httpClient,frigateCameras,frigateStatus,housesWithRooms,getFrigateCamerasStatus,frigateCameraSearch,getFrigateCamerasOrderDir,restartFrigateStatus',
  actions
